...
export const create: { body: ObjectSchema } = {
  body: Joi.object().keys({
    loyaltyProgramName: Joi.string().lowercase().required(),
    businessLocation: Joi.array().items({
      outletId: Joi.string().custom(objectId),
      earnPoint: Joi.number().required(),
      spentAmount: Joi.number().required(),
      mondaySpendAmount: Joi.number().required(),
      mondayEarnPoint: Joi.number().required(),
      tuesdaySpendAmount: Joi.number().required(),
      tuesdayEarnPoint: Joi.number().required(),
      wednesdaySpendAmount: Joi.number().required(),
      wednesdayEarnPoint: Joi.number().required(),
      thursdaySpendAmount: Joi.number().required(),
      thursdayEarnPoint: Joi.number().required(),
      fridaySpendAmount: Joi.number().required(),
      fridayEarnPoint: Joi.number().required(),
      saturdaySpendAmount: Joi.number().required(),
      saturdayEarnPoint: Joi.number().required(),
      sundaySpendAmount: Joi.number().required(),
      sundayEarnPoint: Joi.number().required(),
    }),
  }),
}
...
export const update: { params: ObjectSchema; body: ObjectSchema } = {
  params: Joi.object().keys({
    loyaltyId: Joi.required().custom(objectId),
  }),
  body: Joi.object().keys({
    loyaltyProgramName: Joi.string().lowercase().required(),
    businessLocation: Joi.array().items({
...
export const deleteDocument: { params: ObjectSchema } = {
  params: Joi.object().keys({
    loyaltyId: Joi.string().custom(objectId),
  }),
}
