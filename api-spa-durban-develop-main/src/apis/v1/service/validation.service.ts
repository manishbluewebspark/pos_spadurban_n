...
export const create: { body: ObjectSchema } = {
  body: Joi.object().keys({
    serviceName: Joi.string().lowercase().required(),
    categoryId: Joi.string().custom(objectId),
    subCategoryId: Joi.string().custom(objectId).allow(null),
    serviceCode: Joi.string().allow(""),
    sellingPrice: Joi.number().required(),
    outletIds: Joi.array().items(Joi.string().required().custom(objectId)),
    description: Joi.string().lowercase().required(),
    termsAndConditions: Joi.string().lowercase().required(),
    serviceImageUrl: Joi.string().lowercase().allow(""),
    products: Joi.array()
      .items({
      ...
      .allow(),
    taxId: Joi.string().custom(objectId).allow(null),
  }),
};
