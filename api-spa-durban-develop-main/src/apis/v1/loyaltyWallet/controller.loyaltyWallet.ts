...
import { loyaltyWalletService } from "../service.index"
import {
  DateFilter,
  RangeFilter,
...
import { searchKeys, allowedDateFilterKeys } from "./schema.loyaltyWallet"

const getLoyaltyWallet = catchAsync(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    const result = await loyaltyWalletService.queryLoyaltyWallets(
      filter,
      options
    )
