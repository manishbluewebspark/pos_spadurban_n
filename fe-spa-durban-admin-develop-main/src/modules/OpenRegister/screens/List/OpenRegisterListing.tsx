...
type Props = {
  ...
  rowData: Register[];
  tableHeaders: TableHeader<Register>[];
    ...
    <>
      <div className="flex flex-col h-full gap-2 p-4">
        <ATMPageHeader
          ...
          hideButton={!isAuthorized('REGISTER_ADD')}
        />
        <Authorization permission="REGISTER_LIST">
          <div className="flex flex-col overflow-auto border rounded border-slate-300">
            ...
            <div className="flex-1 overflow-auto">
              <MOLTable<Register>
                ...
                onEdit={isAuthorized('REGISTER_UPDATE') ? onEdit : undefined}
                onDelete={
                  isAuthorized('REGISTER_DELETE')
...
export default OpenRegisterListing;
